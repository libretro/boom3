...
extern idCVar r_specularAA;			// Toksvig: widen specular by mip-shortened normal variance
...
typedef enum {
	...
	FPROG_FF_GAMMA_GUI,    // same, with the ACES 2.0 inverse applied to the texel
	//
	PROG_USER
} program_t;
