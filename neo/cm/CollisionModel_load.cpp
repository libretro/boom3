...
void idCollisionModelManagerLocal::PrintModelInfo( const cm_model_t *model ) {
	common->Printf( "%6i vertices (%i KB)\n", model->numVertices, (int)( ( model->numVertices * sizeof( cm_vertex_t ) ) >> 10 ) );
	common->Printf( "%6i edges (%i KB)\n", model->numEdges, (int)( ( model->numEdges * sizeof( cm_edge_t ) ) >> 10 ) );
	...
	common->Printf( "%6i nodes (%i KB)\n", model->numNodes, (int)( ( model->numNodes * sizeof( cm_node_t ) ) >> 10 ) );
	common->Printf( "%6i polygon refs (%i KB)\n", model->numPolygonRefs, (int)( ( model->numPolygonRefs * sizeof( cm_polygonRef_t ) ) >> 10 ) );
	common->Printf( "%6i brush refs (%i KB)\n", model->numBrushRefs, (int)( ( model->numBrushRefs * sizeof( cm_brushRef_t ) ) >> 10 ) );
